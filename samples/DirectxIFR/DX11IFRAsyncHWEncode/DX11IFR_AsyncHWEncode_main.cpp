/*!
 * \brief
 * Shows how to use NvIFR to grab and encode a render frame from 
 * D11 asynchronously, rather than block the render thread.
 *
 * \file
 *
 * This DX11 sample demonstrates grabbing and encoding a frame asynchronously using 
...
#define SAMPLE_NAME		"DX11IFR_AsyncHWEncode"
...
std::string g_sBaseName = "DX11IFR_AsyncHWEncode"; // Default Basename for the output stream
